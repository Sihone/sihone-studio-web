...
<body class="tt-magic-cursor digital-agency">
        ...
        <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
            ...
            <div class="menu-wrap">
                ...
                <div class="nav-right">
                    ...
                    <a href="contact.php" class="primary-btn3 btn-hover d-lg-flex d-none acctive">
                        Contact Us
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="single-contact">
                        <h4>Canada & US</h4>
                        <ul class="contact-list" style="padding-top: 0;">
                            <li>
                                <div class="icon">
                                ...
                                <div class="content">
                                    ...
                                    <h6><a href="tel:+16134248006">+1 (613) 424 8006</a></h6>
                                </div>
                            </li>
                        </ul>
                        <br>
                        ...
                        <ul class="contact-list" style="padding-top: 0;">
                            <li>
                                ...
                                <div class="content">
                                    <span>Call / WhatsApp</span>
                                    <h6><a href="tel:+237696509794">+237 696 50 97 94</a></h6>
                                </div>
                            </li>
                        </ul>
                        <br>
                        ...
                        <ul class="contact-list" style="padding-top: 0;">
                            <li>
                                ...
                                <div class="content">
                                    ...
                                    <h6><a href="mailto:contact@sihonestudio.com">contact@sihonestudio.com</a></h6>
                                </div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-12 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="contact-form-wrap style-2">
                        <div class="section-title three text-center">
                            <h2>Collaborate with Us!</h2>
                            <p>We’re excited to hear from you! Whether you have a question about our services or want to discuss a new project.</p>
                        </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        <label>Name *</label>
                                        <input type="text" placeholder="Daniel" name="name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        <label>Company</label>
                                        <input type="text" placeholder="MTN" name="company">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner">
                                ...
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        <label>Phone *</label>
                                        <input type="text" placeholder="+237 6** ** ** **" name="phone" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck1" name="websites" value="true">
                                                    <label class="form-check-label" for="contactCheck1">
                                                        Web Apps, Branding & Automation
                                                    </label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck2" name="digital" value="true">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck3" name="incubator" value="true">
                                            ...
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="contactCheck4" name="creator" value="true">
                                                    <label class="form-check-label" for="contactCheck4">
                                                        Creator Management & Monetization
                                                    </label>
                                                </div>
                                            </li>
                                        </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="hidden" name="subject" value="Sihone Studio Contact Form">
                                    </div>
                                </div>
                            </div>
                            <div class="form-inner2 two">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="contactCheck22">
                                        By submitting, you will agree our <a href="policy.html" target="_blank"> privacy policy & terms conditions</a>.
                                    </label>
                                </div>
                            </div>
                            <button type="submit" class="primary-btn3 btn-hover" disabled>
                                Submit Now
                                <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                        ...
                        <script>
                            ...
                            form.addEventListener('submit', (event) => {
                                ...
                                // sending through get in send.php file
                                fetch('send.php', {
                                    method: 'POST',
                                    body: data
                                })
                        ...
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseOne">What makes Sihone Studio different from other agencies?</button>
                            </h5>
                            <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    We combine deep technical expertise with creative strategy — offering everything from branding and websites to automation and monetization — under one roof. Our focus is on full digital control, not just visibility.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseTwo">Can you work with businesses outside Canada or Cameroon?</button>
                            </h5>
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    Absolutely. Our team is fully remote and experienced in handling international projects. We collaborate seamlessly using cloud tools and adapt to your time zone and preferences.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingThree">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseThree">Do you work with creators or only businesses?</button>
                            </h5>
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    We work with both. Our monetization offering is tailored specifically for creators, helping them build personal brands, digital products, and scalable income streams.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingFour">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseFour">How do you ensure the solutions you build actually convert?</button>
                            </h5>
                            <div id="flush-collapseFour" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    We prioritize strategy before design. Every website, campaign, or brand system we build is rooted in data, user psychology, and conversion-first frameworks.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingFive">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseFive"> I already have a team — can you work with them?</button>
                            </h5>
                            <div id="flush-collapseFive" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    Yes. We often collaborate with in-house or third-party teams, offering strategy, development, or creative input where needed. Think of us as a plug-and-play digital partner.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingSix">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseSix">What kind of businesses do you work best with?</button>
                            </h5>
                            <div id="flush-collapseSix" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    We thrive with growth-minded brands — startups, solopreneurs, NGOs, and SMEs — especially those ready to embrace digital transformation or monetize their audience.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                            <h5 class="accordion-header" id="flush-headingSeven">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    aria-expanded="false" aria-controls="flush-collapseSeven">What happens after a project is completed?</button>
                            </h5>
                            <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingSeven" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    You’ll receive full ownership, training (if needed), and the option for ongoing support or marketing retainers. We don’t ghost after delivery — we grow with you.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/DrawSVGPlugin3.min.js"></script>
